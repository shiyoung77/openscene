...
echo "8 - Matterport 3D with top 40 NYU classes"
echo "9 - Matterport 3D with top 80 NYU classes"
echo "10- Matterport 3D with top 160 NYU classes"
...
then
    echo "You chose 8: Matterport 3D with top 40 NYU classes"
    mkdir -p data
    cd data
    echo "Start downloading ..."
...
then
    echo "You chose 9: Matterport 3D with top 80 NYU classes"
    mkdir -p data
    cd data
    echo "Start downloading ..."
...
then
    echo "You chose 10: Matterport 3D with top 160 NYU classes"
    mkdir -p data
    cd data
    echo "Start downloading ..."
