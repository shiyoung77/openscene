...
def get_args():
    ...
    # parser.add_argument('--data_dir', type=str, default="/home/lsy/dataset/ycb_video_processed")
    # parser.add_argument('--output_dir', type=str, default='/home/lsy/dataset/ycb_video_processed_output')
    parser.add_argument('--data_dir', type=str, default="/home/lsy/dataset/custom_tabletop_processed")
    parser.add_argument('--output_dir', type=str, default='/home/lsy/dataset/custom_tabletop_processed_output')
    parser.add_argument('--openseg_model', type=str, default="/home/lsy/Downloads/openseg_exported_clip")
...
def main(args):
    ...
    img_dim = (640, 480)
    depth_scale = 1000
    # scenes = [f"{i:04d}" for i in range(51, 60)]
    # scenes = [f'recording{i}' for i in [9, 10, 11, 12, 13, 14]]
    scenes = [f'recording{i}' for i in [14]]
    ...
    data_root = join(data_dir, 'custom_tabletop_3d')
    data_root_2d = join(data_dir, 'custom_tabletop_2d')
